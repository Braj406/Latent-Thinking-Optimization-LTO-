...
# Point this to your new GitHub architecture in Drive
sys.path.append('/content/drive/MyDrive/Latent Thinking Optimization/Deepseek Model') 
...
mbpp_path = '/content/drive/MyDrive/cdeepseek_lto_dataset.pt'
...
=
    ...
    run_evaluation(combined_data, "MASTER PASS@K METRICS on DeepSeek Trajectories")
